...
CONTROL_DESCRIPTION = "Ensure that ECR repositories are encrypted using KMS"

def main():
    print(CONTROL_DESCRIPTION)

    with open('/tmp/cid_358_controls.csv', mode='w', newline='') as csv_file:
        ...
        for region in REGIONS:
            ...
            try:
                ...
                for repository in repositories:
                    ...
                    evidence = f"['encryptionConfiguration': {encryption_configuration}]"

                    if str(encryption_configuration.get("encryptionType")) != "KMS":
